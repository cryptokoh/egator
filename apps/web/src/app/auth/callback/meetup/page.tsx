      ...
      <div className="min-h-screen bg-bg-primary flex items-center justify-center p-4">
        <div className="max-w-lg w-full bg-bg-surface rounded-2xl p-8 border border-border-subtle">
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-text-primary mb-2">Meetup Connected!</h1>
            <p className="text-text-secondary">Your Meetup account has been authorized.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t border-border-subtle">
              ...
              <code className="block w-full p-3 bg-bg-primary rounded-lg text-green-400 text-xs font-mono border border-border-subtle overflow-x-auto">
                ...
                {'  '}-d "redirect_uri=https://aiegato.netlify.app/auth/callback/meetup"
              </code>
            </div>

            <div className="pt-4 border-t border-border-subtle">
              <p className="text-sm text-text-tertiary mb-3">
                Add to your <code className="text-accent">.env</code> file:
              </p>
              <code className="block w-full p-3 bg-bg-primary rounded-lg text-green-400 text-sm font-mono border border-border-subtle">
                MEETUP_ACCESS_TOKEN=your_exchanged_token
              </code>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-bg-primary flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-bg-surface rounded-2xl p-8 border border-border-subtle">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-text-primary mb-2">Connecting to Meetup</h1>
...
export default function MeetupCallbackPage() {
  return (
    <Suspense fallback={
